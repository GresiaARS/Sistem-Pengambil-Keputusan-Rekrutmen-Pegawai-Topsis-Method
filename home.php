          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                ...
                <h2>Kami sedang melaksanakan <em>Rekruitmen </em><span>Back-end Developer</span></h2>
                <p>Untuk info lebih lanjut mengani perusahaan ini silahkan kunjungi website <a rel="nofollow" href="https://www.sirclo.com/" target="_parent">berikut.</a>.</p>
                <div class="main-blue-button">
                  <a href="index.php">LAMAR SEKARANG</a></div></li> 
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="img/founder.jpg" alt="team meeting">
              </div>
            </div>
          </div>
        </div>
