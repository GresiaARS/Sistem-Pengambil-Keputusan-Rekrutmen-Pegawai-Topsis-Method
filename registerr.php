...
if( isset($_POST['submit']) ){
        ...
        if(!empty(trim($fullname)) && !empty(trim($username)) && !empty(trim($level)) && !empty(trim($password)) && !empty(trim($repass))){
            ...
            if($password == $repass){
                ...
                if( cek_nama($fullname,$conn) == 0 ){
                    ...
                    $query = "INSERT INTO user (id, username, password, fullname, level ) VALUES ('', '$username','$pass','$fullname','$level')";
